-- ============================================
-- SCRIPT DE MIGRACIÓN PRODUCCIÓN - DATOS REALES
-- ============================================
-- EJECUTAR EN SUPABASE - SQL EDITOR
-- Esto borra todo y carga todos los datos reales

-- PASO 1: Limpiar todo
TRUNCATE TABLE registros_mensuales CASCADE;
TRUNCATE TABLE cliente_productos CASCADE;
TRUNCATE TABLE productos CASCADE;
TRUNCATE TABLE clientes CASCADE;

-- PASO 2: Insertar todos los CLIENTES
...
-- PASO 3: Insertar PRODUCTOS ÚNICOS
...
-- PASO 4: Crear RELACIONES CLIENTE-PRODUCTO automáticamente
-- Esto ejecuta un query que inserta todas las relaciones basado en el archivo CSV
...
UNION ALL
SELECT 'Registros', COUNT(*) FROM registros_mensuales;
